========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet perfmon_
========================================================================

AppWizard a créé cette application perfmon_ pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application perfmon_.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé perfmon_.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
